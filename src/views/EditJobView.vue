...
onMounted (async () => {
     try {
          ...
          mainJob.value = response.data;
     form.title = mainJob.value.title;
     form.type = mainJob.value.type;
     form.location = mainJob.value.location;
     form.description = mainJob.value.description;
     form.salary = mainJob.value.salary;
     form.company.name = mainJob.value.company.name;
     form.company.description = mainJob.value.company.description;
     form.company.contactEmail = mainJob.value.company.contactEmail;
     form.company.contactPhone = mainJob.value.company.contactPhone;
     ...
     <section class="bg-green-50">
          <div class="container m-auto max-w-2xl py-24">
               <div class="bg-white px-6 py-8 mb-4 shadow-md rounded-md border m-4 md:m-0">
                    <form @submit.prevent="handleSubmit" v-if="mainJob != null">
                         ...
                         <div class="mb-4">
                              <label for="contact_email" class="block text-gray-700 font-bold mb-2">Contact
                                   Email</label>
                         ...
                         <div class="mb-4">
                              <label for="contact_phone" class="block text-gray-700 font-bold mb-2">Contact
                                   Phone</label>
